...
title = """<h1 align="center">GPT-5 nano: Research Preview (Short-Term Availability)</h1>"""
if DISABLED:
...
...
```
In this app, you can explore the outputs of a gpt-5-nano LLM.
"""
...
with gr.Blocks(css = """#col_container { margin-left: auto; margin-right: auto;}
              ...
              theme=theme) as demo:
    gr.HTML(title)
    gr.HTML("""<h3 align="center">This app provides you full access to GPT-5 nano (400K token limit). You don't need any OPENAI API key.</h3>""")
    gr.HTML("""
